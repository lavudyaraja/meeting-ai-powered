...
import { Brain, X, LayoutDashboard, Calendar, CheckCircle, Video, MessageSquare, BarChart3, Settings, Users, Activity, Building, Shield, Film, Sparkles, CreditCard, Bell, HelpCircle, LogOut, Moon, Sun, User, Play, Bot, Menu, ChevronLeft, ChevronRight } from "lucide-react";
...
const DashboardLayout = ({ onPageChange, children }: DashboardLayoutProps) => {
  ...
  const menuItems = [
    ...
    { id: "ai-management", label: "AI Management", icon: Bot, path: "/dashboard/ai-management" },
    { id: "ai-meeting-assistant", label: "AI Meeting Features", icon: Sparkles, path: "/ai-meeting-assistant" },
    { id: "analytics", label: "Analytics", icon: BarChart3, path: "/dashboard/analytics" },
    { id: "team", label: "Team Management", icon: Users, path: "/dashboard/team" },
    { id: "activity", label: "Team Activity", icon: Activity, path: "/dashboard/activity" },
  ...
  const profileMenuItems = [
    ...
    { id: "settings", label: "Settings", icon: Settings, description: "Account & privacy", path: "/settings" },
  ...
  const handleProfileAction = (actionId, path) => {
    if (path) {
      navigate(path);
    ...
    <div className="h-screen flex bg-gradient-to-br from-slate-950 via-blue-950 to-slate-950 relative overflow-hidden">
      ...
      >
        ...
        <div className={`flex items-center ${sidebarCollapsed && !isMobile ? "justify-center" : "justify-between"} px-4 py-4 border-b border-slate-800/50`}>
          ...
          >
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-cyan-400 via-blue-500 to-violet-600 flex items-center justify-center shadow-lg shadow-cyan-500/50 group-hover:scale-110 transition-transform duration-300">
              ...
              <div key={item.id} className="relative group/item">
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-3 py-3 rounded-xl transition-all duration-200 group ${
                    isActive
                      ? "bg-gradient-to-r from-cyan-500/20 to-blue-500/20 text-cyan-200 shadow-lg shadow-cyan-500/20"
                ...
                {sidebarCollapsed && !isMobile && (
                  <div className="absolute left-full ml-2 top-1/2 -translate-y-1/2 px-3 py-2 bg-slate-800 text-slate-200 text-sm font-semibold rounded-lg shadow-xl opacity-0 invisible group-hover/item:opacity-100 group-hover/item:visible transition-all duration-200 whitespace-nowrap z-50 pointer-events-none">
                    {item.label}
        ...
        <div className="px-3 pb-4 border-t border-slate-800/50 pt-4 sidebar-footer relative">
          ...
          >
            <div className="relative flex-shrink-0">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-cyan-400 via-blue-500 to-violet-600 flex items-center justify-center text-white font-bold shadow-lg">
          ...
          {profileOpen && (
            <div 
              className={`absolute bg-slate-900/98 backdrop-blur-xl border border-cyan-400/30 rounded-2xl shadow-2xl shadow-black/50 z-50 w-72
                ${sidebarCollapsed && !isMobile
            ...
            >
              ...
              <div className="p-4 border-b border-slate-800/50">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-cyan-400 via-blue-500 to-violet-600 flex items-center justify-center text-white font-bold shadow-lg">
                    {userProfile.avatar_url ? (
                      <img 
                        src={userProfile.avatar_url} 
                        alt={userProfile.full_name} 
      ...
      >
        {/* Navbar */}
        <header className="sticky top-0 z-30 bg-slate-900/80 backdrop-blur-xl border-b border-cyan-400/20 px-4 sm:px-6 py-4">
