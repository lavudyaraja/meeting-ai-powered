              ...
              <div className="space-y-6">
                ...
                <h1 className="text-5xl font-bold text-slate-100 leading-tight">
                  ...
                  <span className="block text-indigo-400 mt-2">
                    With AI-Powered Meetings
                  </span>
                </h1>

                <p className="text-lg text-slate-400 leading-relaxed max-w-md">
                  Join thousands of professionals who are transforming their meeting productivity with intelligent transcription and insights.
                </p>
                ...
                <div className="space-y-4 pt-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="text-slate-200 font-medium">Automatic Transcription</div>
                      <div className="text-sm text-slate-400">Real-time meeting transcription with high accuracy</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-indigo-600/20 border border-indigo-600 flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <div>
                      <div className="text-slate-200 font-medium">Smart Insights</div>
                      <div className="text-sm text-slate-400">AI-powered analysis and action items extraction</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-indigo-600/20 border border-indigo-600 flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <div>
                      <div className="text-slate-200 font-medium">Secure & Private</div>
                      <div className="text-sm text-slate-400">Enterprise-grade security for your data</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="w-full max-w-md mx-auto lg:mx-0">
              <Card className="bg-slate-800 border border-slate-700 p-8 lg:p-10 rounded-2xl">
                ...
                <div className="text-center mb-8">
                  <h2 className="text-3xl font-bold text-slate-100 mb-2">Get Started</h2>
